                                        ...
                                        if(fotoPerfilUri!=null) {
                                            ...
                                            UsuarioDAO.getInstancia().subirFotoUri(fotoPerfilUri, new UsuarioDAO.IDevolverUrlFoto() {
                                                ...
                                                public void devolerUrlString(String url) {
                                                    ...
                                                    DatabaseReference referenceContacts = database.getReference("Usuarios/"+currentUser.getUid() + "/" + Constantes.NODO_CONTACTS);
                                                    List<String> list = new ArrayList<>();
                                                    list.add("");   //El primero lo pongo vacio para generar la lista en BD, empezaremos a contar desde el 1
                                                    referenceContacts.setValue(list);
                                                    finish();
                                                }
                                            });
